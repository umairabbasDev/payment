...
<form name="jsform" method="post" action="https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/">
    ...
    <div className="formFielWrapper">
        ...
        <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="T20201109235902"/>
    </div>
    ...
    <input type="hidden" name="pp_TxnDateTime" value="20201109235902"/>
    <div className="formFielWrapper">
    ...
    <input type="hidden" name="pp_TxnExpiryDateTime" value="20201110235902"/>
